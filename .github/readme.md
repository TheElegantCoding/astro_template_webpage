...
<h3 id="seo-configuration">SEO configuration</h3>

To have a correct SEO setup in your project you have to include these basic variables in the base layout component, these three objects are mandatory yo have in the project:
...
There is also the posibility to add structured data, if yo don't know about this feature here are [some exmples](https://developers.google.com/search/docs/appearance/structured-data/search-gallery)

We will list all the props that we have available and also a full working example of the component
...
<table border>
  ...
  <tr>
    ...
    <td align="center">
      The description of the page, recommended to be 150 characters
    </td>
    <td align="center">
      <pre>string</pre>
    </td>
